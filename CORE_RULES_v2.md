...
**正确流程：先判资产类别 → 再算六维分数 → 再套对应价格模型 → 输出三档价格**
...
| `ULTRA_WORD_COM` | 顶级单词/强品类词 + .com（cloud, excel, text, derm 等） | **92** | $500,000 – $2,000,000+ | 投资人流通底价｜P3 战略假设价待 AI 核验 |
